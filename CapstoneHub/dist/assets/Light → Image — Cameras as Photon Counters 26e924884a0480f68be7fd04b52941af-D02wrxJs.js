...
Every patch of light that reaches the lens is a stream of photons. These photons arrive one by one, each carrying a discrete packet of energy [1]. The camera’s role is to record how many of them arrive.

The process begins at the sensor. A modern image sensor is made of silicon, and when a photon strikes it, there’s a chance it will knock an electron loose. This is the photoelectric effect—the same principle that earned Einstein his Nobel Prize. One photon can free one electron, and that freed electron is the signal a camera registers [2]. When light hits the sensor, it transforms into an electrical charge moving through circuits in the camera [3][4].
