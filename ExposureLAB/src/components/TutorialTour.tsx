...
export const TutorialTour = ({
  ...
  if (targetRect && !useCenteredLayout) {
    ...
    // Prefer placing the card above the highlighted area so we don't cover it.
  ...
  // Simple arrow from the instruction card toward the highlighted element
  // No arrow in ExposureLAB tour to keep the overlay simpler.
